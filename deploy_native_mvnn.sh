...
#SBATCH --output=logs/job_native_mvnn.out     # File to which STDOUT will be written
#SBATCH --error=logs/job_native_mvnn.err      # File to which STDERR will be written
...
# Run our code
echo "-------- PYTHON OUTPUT ----------"
python3 uq_comparison_pipeline_mvnn.py
echo "---------------------------------"
