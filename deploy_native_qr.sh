...
#SBATCH --output=logs/job_native_qr.out     # File to which STDOUT will be written
#SBATCH --error=logs/job_native_qr.err      # File to which STDERR will be written
...
# Run our code
echo "-------- PYTHON OUTPUT ----------"
python3 uq_comparison_pipeline_qr.py
echo "---------------------------------"
