...
#SBATCH --time=0-07:00            # Runtime in D-HH:MM
...
#SBATCH --output=logs/job_posthoc_la.out     # File to which STDOUT will be written
#SBATCH --error=logs/job_posthoc_la.err      # File to which STDERR will be written
...
# Run our code
echo "-------- PYTHON OUTPUT ----------"
python3 uq_comparison_pipeline_la.py
echo "---------------------------------"
