...
io_helper = IO_Helper()
model2 = io_helper.load_torch_model_statedict(model_class=NN_Estimator, model_kwargs=model_kwargs,
                                              filename='base_model_nn_n210432_it200_nh2_hs50_dict.pth')
io_helper.save_torch_model(model2, filename='base_model_nn_n210432_it200_nh2_hs50_model2.pth')
